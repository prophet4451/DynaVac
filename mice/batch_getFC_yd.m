function [batch_titer_lgFC,batch_titer_est_lgFC,titer_group,titer_time,titer_sample]=batch_getFC_yd(batch_vaccine_varient,batch_vaccine_time,batch_t,batch_Abt,batch_sample,titers,X_pse,self_neu,vaccine_correspond,sub_pse)
...
batch_titer_lgFC=batch_titer_lgFC(sub_pse,:);
