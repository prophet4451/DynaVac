function Funcollect=EvaluationFunc(vaccine_varient,vaccine_type,vaccine_time,vaccine_amount,X,self_neu,parameter_set,n_varient)
...
Funcollect.a_pre=@(t,vaccine_time) a_pre(t,vaccine_varient,vaccine_time,parameter_set,n_varient);
...
function active=a_pre(t,vaccine_varient,vaccine_time,parameter_set,n_varient) 
t_start=parameter_set(10);
